...
abstract class ChatRepository {
  ...
  Future<ChatMessage> sendMessage(String text, {List<String>? files, List<ChatMessage>? history});

  /// Returns a stream of response chunks for real-time "typing" effects.
  Stream<String> streamResponse(String text, {List<String>? files, String? requestId, List<ChatMessage>? history});
}
